...
class TestTradingControls(TestCase):
    ...
    def _check_algo(self,
        ...
        with self.assertRaises(expected_raise) if expected_raise else Noop():
            algo.run(self.source)
    ...
    def test_set_max_position_size(self):
        ...
        def handle_data(algo, data):
            ...
            algo.order_count += 1
        algo = SetMaxPositionSizeAlgorithm(self.sid,
                                           max_shares=10,
                                           max_notional=500.0)
        ...
        def handle_data(algo, data):
            ...
            algo.order_count += 1
        algo = SetMaxPositionSizeAlgorithm(self.sid + 1,
                                           max_shares=10,
                                           max_notional=61.0)
        self.check_algo_succeeds(algo, handle_data)
    ...
    def test_set_max_order_size(self):
        ...
        def handle_data(algo, data):
            algo.order(self.sid, 1)
            algo.order_count += 1
        algo = SetMaxOrderSizeAlgorithm(self.sid,
                                        max_shares=10,
                                        max_notional=500.0)
        self.check_algo_succeeds(algo, handle_data)
        ...
        def handle_data(algo, data):
            algo.order(self.sid, 10000)
            algo.order_count += 1
        algo = SetMaxOrderSizeAlgorithm(self.sid + 1,
                                        max_shares=1,
                                        max_notional=1.0)
        self.check_algo_succeeds(algo, handle_data)
